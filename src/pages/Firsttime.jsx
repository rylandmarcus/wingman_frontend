  ...
  return (
    <div style={{backgroundImage:'linear-gradient(white, pink, lightcoral, red)', minHeight:'1000px', padding:'50px 200px 0px 200px', display:'flex', flexDirection:'row', justifyContent:'space-between'}}>
        <Form action='/activate' method='post' style={{
            ...
            <h2 style={{color:'#D6D6D7'}}>Creating {user.username}'s Profile</h2>
            ...
            <select className='authInput' style={{fontSize:'20px', width:'350px'}} name="interested" required>
            ...
            <input className='profileButton' type="submit" value="Create Profile!"/>
        </Form>
        <div style={{
            backgroundColor:'#202124',
            border:'20px',
